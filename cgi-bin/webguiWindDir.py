...
def show_graph(chartId):
    ...
    #divId ='<div id='+chartId+' style="width: 900px; height: 500px;"></div>' 
...
def print_time_selector(option):
    ...
    print """<form action="/cgi-bin/webguiWindDir.py" method="POST">
    ...
    if option is not None:
        ...
        if option == "500":
            print "<option value=\"500\" selected=\"selected\">the last 24 hours</option>"
        else:
            print "<option value=\"500\">the last 500 hours</option>"
...
def main():
    ...
    printHTMLHead("Raspberry Pi Temperature Logger", table,"chart_div")
#    printHTMLHead("Raspberry Pi Temperature Logger", table,"chart_div1")
    # print the page body
    print "<body>"
